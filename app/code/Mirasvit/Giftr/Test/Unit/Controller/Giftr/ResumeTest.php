...
namespace Mirasvit\Giftr\Test\Unit\Controller\Giftr;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Giftr\Controller\Giftr\Resume
...
class ResumeTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Giftr\Controller\Giftr\Resume|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $giftrController;
...
'Magento\Framework\Message\ManagerInterface', [], '', false, true, true, []
        ...
        $this->giftrController = $this->objectManager->getObject(
            '\Mirasvit\Giftr\Controller\Giftr\Resume',
            [
    ...
    {
        $this->assertEquals($this->giftrController, $this->giftrController);
    }
}
