...
/**
 * @covers \Mirasvit\Giftr\Controller\Item\Manage
...
class ManageTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Giftr\Controller\Item\Manage|\PHPUnit_Framework_MockObject_MockObject
     */
...
'Magento\Framework\Message\ManagerInterface', [], '', false, true, true, []
        ...
        $this->itemController = $this->objectManager->getObject(
            '\Mirasvit\Giftr\Controller\Item\Manage',
            [
