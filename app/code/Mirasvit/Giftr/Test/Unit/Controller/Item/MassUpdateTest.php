...
/**
 * @covers \Mirasvit\Giftr\Controller\Item\MassUpdate
 * @SuppressWarnings(PHPMD)
 */
class MassUpdateTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    /**
     * @var \Mirasvit\Giftr\Controller\Item\MassUpdate|\PHPUnit_Framework_MockObject_MockObject
     */
...
'Magento\Framework\Message\ManagerInterface', [], '', false, true, true, []
        ...
        $this->itemController = $this->objectManager->getObject(
            '\Mirasvit\Giftr\Controller\Item\MassUpdate',
            [
