...
namespace Mirasvit\Giftr\Test\Unit\Controller\Search;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Giftr\Controller\Search\Result
...
class ResultTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Giftr\Controller\Search\Result|\PHPUnit_Framework_MockObject_MockObject
     */
...
'Magento\Framework\Message\ManagerInterface', [], '', false, true, true, []
        ...
        $this->searchController = $this->objectManager->getObject(
            '\Mirasvit\Giftr\Controller\Search\Result',
            [
    ...
    {
        $this->assertEquals($this->searchController, $this->searchController);
    }
}
