...
namespace Mirasvit\Giftr\Test\Unit\Controller\Adminhtml\Field;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Giftr\Controller\Adminhtml\Field\MassChange
...
class MassChangeTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Giftr\Controller\Adminhtml\Field\MassChange|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $fieldController;

    /**
     * @var \Mirasvit\Giftr\Model\FieldFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $fieldFactoryMock;

    /**
     * @var \Mirasvit\Giftr\Model\Field|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $fieldMock;
    ...
    public function setUp()
    {
        $this->fieldFactoryMock = $this->getMock(
            '\Mirasvit\Giftr\Model\FieldFactory',
            ['create'],
            [],
            '',
            false
        ...
        $this->fieldController = $this->objectManager->getObject(
            '\Mirasvit\Giftr\Controller\Adminhtml\Field\MassChange',
            [
