...
namespace Mirasvit\Giftr\Test\Unit\Controller\Adminhtml\Section;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Giftr\Controller\Adminhtml\Section\MassDelete
...
class MassDeleteTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Giftr\Controller\Adminhtml\Section\MassDelete|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $sectionController;

    /**
     * @var \Mirasvit\Giftr\Model\SectionFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $sectionFactoryMock;
    ...
    {
        $this->sectionFactoryMock = $this->getMock(
            '\Mirasvit\Giftr\Model\SectionFactory',
            ['create'],
            [],
            '',
            false
        );
        $this->sectionMock = $this->getMock(
        ...
        $this->sectionFactoryMock->expects($this->any())->method('create')
                ->will($this->returnValue($this->sectionMock));
        ...
        $this->sectionController = $this->objectManager->getObject(
            '\Mirasvit\Giftr\Controller\Adminhtml\Section\MassDelete',
            [
                'sectionFactory' => $this->sectionFactoryMock,
    ...
    {
        $this->assertEquals($this->sectionController, $this->sectionController);
    }
}
