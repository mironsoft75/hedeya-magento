...
class MassDeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/giftr/section/massdelete';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Giftr\Controller\Adminhtml\Section\MassDelete::execute
     */
    public function testMassDeleteAction()
    {
        $this->dispatch('backend/giftr/section/massdelete');
