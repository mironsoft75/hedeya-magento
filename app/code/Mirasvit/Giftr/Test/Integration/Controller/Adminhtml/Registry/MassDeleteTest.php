...
class MassDeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/giftr/registry/massdelete';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Giftr\Controller\Adminhtml\Registry\MassDelete::execute
     */
    public function testMassDeleteAction()
    {
        $this->dispatch('backend/giftr/registry/massdelete');
