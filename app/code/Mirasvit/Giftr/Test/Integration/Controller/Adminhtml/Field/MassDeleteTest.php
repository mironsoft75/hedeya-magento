...
class MassDeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/giftr/field/massdelete';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Giftr\Controller\Adminhtml\Field\MassDelete::execute
     */
    public function testMassDeleteAction()
    {
        $this->dispatch('backend/giftr/field/massdelete');
