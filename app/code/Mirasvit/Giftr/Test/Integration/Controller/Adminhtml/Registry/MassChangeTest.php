...
class MassChangeTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/giftr/registry/masschange';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Giftr\Controller\Adminhtml\Registry\MassChange::execute
     */
    public function testMassChangeAction()
    {
        $this->dispatch('backend/giftr/registry/masschange');
