...
class NewActionTest extends \Magento\TestFramework\TestCase\AbstractController
{
    ...
    /**
     * @covers  Mirasvit\Giftr\Controller\Registry\NewAction::execute
     *
     * @magentoDataFixture Magento/Customer/_files/customer.php
     */
    public function testNewActionAction()
    {
        $this->dispatch('giftr/registry/new');
        $body = $this->getResponse()->getBody();
        $this->assertNotEmpty($body);
        $this->assertNotEquals('noroute', $this->getRequest()->getControllerName());
        $this->assertFalse($this->getResponse()->isRedirect());
        $this->assertContains('Gift Registry Type', $body);
    }
}
