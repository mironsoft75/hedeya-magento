...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set(__('Gift Registry %1', $this->getRegistry()->getName()));
    ...
    protected function addBreadcrumbBlock()
    {
        if ($breadcrumb = $this->getLayout()->getBlock('breadcrumbs')) {
            $breadcrumb->addCrumb('home', [
                ...
                ->addCrumb('giftr_view', [
                    'label' => $this->getRegistry()->getName(),
                    'title' => $this->getRegistry()->getName(),
                ]);
        }
    ...
    {
        $value = $this->getRegistry()->getValueByCode($field->getCode());
